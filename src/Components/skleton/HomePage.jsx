...
import { services } from '../database/Homepage';
import SingleBrandItem from '../pages/Home/Components/developSingleBrandItem';
import { SingleCartItem as SingleCart } from '../pages/Home/Components/developSingleCart';
...
const HomePage = () => { 
    ...
    if(isSuccess && bis && cis && data?.products?.length > 0 && bd?.items?.length > 0 && cd?.items?.length > 0){
        content =         
        <React.Fragment>  
