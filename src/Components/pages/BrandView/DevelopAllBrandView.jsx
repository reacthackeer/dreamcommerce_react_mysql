...
import DevelopAllCategorySingleBrandItemNext from '../Home/Components/DevelopAllCategorySignleBrandItemNext';
import HeaderLinkItem from '../developViewSkeletonComponents/HeaderLinkItems';
    

const DevelopAllBrandView = () => {
...
export default DevelopAllBrandView;