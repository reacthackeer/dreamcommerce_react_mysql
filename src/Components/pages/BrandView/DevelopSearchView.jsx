...
import { useGetUserSearchProductQuery } from '../../../features/product/productApi';
...
const DevelopSearchView = () => {
    ...
    let {data, isLoading, isError, isSuccess, error} = useGetUserSearchProductQuery({searchString: searchText, page, limit});
...
export default DevelopSearchView;