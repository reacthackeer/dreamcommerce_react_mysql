...
import DevelopAllCategorySingleBrandItem from '../Home/Components/DevelopAllCategorySignleBrandItem';
import HeaderLinkItem from '../developViewSkeletonComponents/HeaderLinkItems';
    

const DevelopCategoryAllView = () => {
...
export default DevelopCategoryAllView;