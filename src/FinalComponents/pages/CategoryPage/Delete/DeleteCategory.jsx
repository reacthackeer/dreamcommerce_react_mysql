...
const DeleteCategory = memo(() => {
        ...
        const [provideId,{isLoading: deleteIsLoading, isSuccess: deleteIsSuccess}] = useDeleteSingleCategoryMutation();
    ...
    const deleteDebounceFunction = debounce(handleDeleteCategory, 1000);
