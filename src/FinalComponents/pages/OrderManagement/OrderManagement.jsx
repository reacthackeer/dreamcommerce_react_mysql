...
import ProductOrderTable from '../OrderPrintPage/childComponents/ProductTable';
...
const OrderManagement = () => {
    ...
    const {data} = useGetAllAdminOrderProductQuery({status: currentState, page, peerPage: limit, phoneNumber: phoneNumber.length === 11 ? phoneNumber: ''}); 
    useEffect(()=>{ 
