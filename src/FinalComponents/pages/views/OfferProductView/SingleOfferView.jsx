...
import { useGetSingleOfferQuery } from '../../../../features/offer/offerApi';
...
const SingleOfferView = () => {
    ...
    let {offerName} = params;   
    let {data, isLoading, isError, isSuccess, error} = useGetSingleOfferQuery({page: page, peerPage: limit, offer: offerName});
    ...
    let linksArray = [
        {name: 'HOME', link: '/'}, 
        {name: 'OFFERS / '+ offerName.split("__").join(" ").toUpperCase(), link: `/offers/${offerName}`},
    ] 
